...
func (d *UserMemoryRepo) Get(nick string) (*model.Account, error) {
	return d.accounts[nick], nil
}

func (d *UserMemoryRepo) Create(nick, password, mail string) (*model.Account, error) {
	if d.Exists(nick) {
...
func (d *UserMemoryRepo) Exists(nick string) bool {
	_, ok := d.accounts[nick]
	return ok
}

func (d *UserMemoryRepo) Load(nick string) (*model.Character, error) {
	return d.characters[nick], nil
}

func (d *UserMemoryRepo) SaveAccount(acc *model.Account) error {
	return nil
}

func (d *UserMemoryRepo) SaveCharacter(char *model.Character) error {
	return nil
}

func (d *UserMemoryRepo) CreateAccountAndCharacter(nick, password, mail string, race model.Race, gender model.Gender, 
