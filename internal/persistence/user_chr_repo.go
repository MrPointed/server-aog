...
type UserChrRepo struct {
	basePath string
}

func NewUserChrRepo(basePath string) *UserChrRepo {
	return &UserChrRepo{basePath: basePath}
}

func (d *UserChrRepo) getFilePath(nick string) string {
	return fmt.Sprintf("%s/%s.chr", d.basePath, strings.ToLower(nick))
}

func (d *UserChrRepo) Exists(nick string) bool {
...
func (d *UserChrRepo) Get(nick string) (*model.Account, error) {
	data, err := ReadINI(d.getFilePath(nick))
	if err != nil {
		return nil, err
	}
...
func (d *UserChrRepo) Create(nick, password, mail string) (*model.Account, error) {
	acc := &model.Account{
		Nick:     nick,
		Password: password,
		Mail:     mail,
...
func (d *UserChrRepo) SaveAccount(acc *model.Account) error {
...
func (d *UserChrRepo) SaveCharacter(char *model.Character) error {
...
func (d *UserChrRepo) CreateAccountAndCharacter(nick, password, mail string, race model.Race, gender model.Gender, 
...
func (d *UserChrRepo) writeINI(path string, data map[string]map[string]string) error {
...
func (d *UserChrRepo) readINI(path string) (map[string]map[string]string, error) {
	return ReadINI(path)
}
