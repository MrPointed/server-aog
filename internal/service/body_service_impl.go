...
type CharacterBodyServiceImpl struct {
...
func NewCharacterBodyServiceImpl(cfg *config.ProjectConfig) BodyService {
	s := &CharacterBodyServiceImpl{
...
func (s *CharacterBodyServiceImpl) setupFromConfig(cfg *config.ProjectConfig) {
...
func (s *CharacterBodyServiceImpl) parseHeadRange(r string) []int {
	var heads []int
...
func (s *CharacterBodyServiceImpl) IsValidHead(head int, race model.Race, gender model.Gender) bool {
...
func (s *CharacterBodyServiceImpl) GetBody(race model.Race, gender model.Gender) int {
