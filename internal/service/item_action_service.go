...
func NewItemActionService(objSvc *ObjectService, msgSvc *MessageService, intSvc *IntervalService, bodySvc *CharacterBodyService) *ItemActionService {
	s := &ItemActionService{
...
func (s *ItemActionService) UseItem(char *model.Character, slot int, connection protocol.Connection) {
...
func (s *ItemActionService) EquipItem(char *model.Character, slot int, connection protocol.Connection) {
	if char == nil || char.Dead {
		return
	}
...
func (s *ItemActionService) CanEquip(char *model.Character, obj *model.Object, connection protocol.Connection) bool {
	// Dead check
	if char.Dead {
		connection.Send(&outgoing.ConsoleMessagePacket{
...
func (s *ItemActionService) registerDefaultBehaviors() {
	// Use behaviors
...
func (s *ItemActionService) SyncSlot(char *model.Character, slot int, connection protocol.Connection) {
	itemSlot := char.Inventory.GetSlot(slot)
...
func (s *ItemActionService) RemoveOne(char *model.Character, slot int, connection protocol.Connection) {
	itemSlot := char.Inventory.GetSlot(slot)
	itemSlot.Amount--
